...
$(function () {
  ...
  $demoSettings.append(
    ...
    + 'Fijar Dise&ntilde;o'
    + '</label>'
    + '<p>Activa el dise&ntilde;o fijo. No se puede usar dise&ntilde;os fijos enmarcados juntos</p>'
    + '</div>'
    // Boxed layout
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    + '<input type="checkbox"data-layout="layout-boxed" class="pull-right"/> '
    + 'Enmarcar Dise&ntilde;o'
    + '</label>'
    + '<p>Activa el enmarcado del dise&ntilde;o</p>'
    + '</div>'
    // Sidebar Toggle
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    ...
    + '</label>'
    + '<p>Dejar que la barra lateral se expanda</p>'
    + '</div>'
    ...
    + '</label>'
    + '<p>Alterna entre la diapositiva sobre el contenido y pone efectos de contenido</p>'
    + '</div>'
    // Control Sidebar Skin Toggle
    + '<div class="form-group">'
    + '<label class="control-sidebar-subheading">'
    + '<input type="checkbox"data-sidebarskin="toggle"class="pull-right"/> '
    + 'Alternar m&aacute;scaras'
    + '</label>'
    + '<p>Alterna entre m&aacute;scaras oscuras y claras para la barra lateral derecha</p>'
    + '</div>'
  )
